...
class MedicineForm(ctk.CTkFrame):
    ...
    def _build_form(self) -> None:
        """Construct the form UI layout."""
        # Top Feedback Banner (Hidden by default, shown on save/error)
        ...
        # Note: feedback banner is mapped dynamically via .grid()

        # Two-column container or vertical sections
        ...
        ctk.CTkLabel(
            med_card,
            text="General identification of the medicine",
            font=FONT_CAPTION,
            text_color="gray",
            anchor="w",
        ...
        ctk.CTkLabel(med_card, text="Medicine Name *", font=FONT_BODY_BOLD, anchor="w").pack(
        ...
        # Strength (Optional)
        ctk.CTkLabel(med_card, text="Strength (Optional)", font=FONT_BODY, anchor="w").pack(
            fill="x", padx=16, pady=(4, 2)
        )
        ...
        self.strength_entry.pack(fill="x", padx=16, pady=(0, 10))

        # Manufacturer (Optional)
        ctk.CTkLabel(med_card, text="Manufacturer (Optional)", font=FONT_BODY, anchor="w").pack(
            fill="x", padx=16, pady=(4, 2)
        )
        ...
        self.manufacturer_entry.pack(fill="x", padx=16, pady=(0, 10))

        # Medicine Type (Optional)
        ctk.CTkLabel(med_card, text="Form / Type (Optional)", font=FONT_BODY, anchor="w").pack(
            fill="x", padx=16, pady=(4, 2)
        )
        ...
        self.type_menu.pack(fill="x", padx=16, pady=(0, 10))

        # Barcode (Optional)
        ctk.CTkLabel(med_card, text="Barcode (Optional)", font=FONT_BODY, anchor="w").pack(
            fill="x", padx=16, pady=(4, 2)
        )
        ...
        self.barcode_entry.pack(fill="x", padx=16, pady=(0, 10))

        # Notes (Optional)
        ctk.CTkLabel(med_card, text="Notes (Optional)", font=FONT_BODY, anchor="w").pack(
            fill="x", padx=16, pady=(4, 2)
        )
        ...
        self.notes_entry.pack(fill="x", padx=16, pady=(0, 20))
        ...
        ctk.CTkLabel(batch_card, text="Expiry Date * (YYYY-MM-DD)", font=FONT_BODY_BOLD, anchor="w").pack(
            fill="x", padx=16, pady=(4, 2)
        )
        ...
        self.expiry_entry.pack(fill="x", padx=16, pady=(0, 10))

        # Batch Number (Optional)
        ctk.CTkLabel(batch_card, text="Batch / Lot Number (Optional)", font=FONT_BODY, anchor="w").pack(
            fill="x", padx=16, pady=(4, 2)
        )
        ...
        self.batch_entry.pack(fill="x", padx=16, pady=(0, 10))

        # Quantity (Optional)
        ctk.CTkLabel(batch_card, text="Quantity / Count (Optional)", font=FONT_BODY, anchor="w").pack(
            fill="x", padx=16, pady=(4, 2)
        )
        ...
        self.quantity_entry.pack(fill="x", padx=16, pady=(0, 10))

        # Storage Location (Optional)
        ctk.CTkLabel(batch_card, text="Storage Location (Optional)", font=FONT_BODY, anchor="w").pack(
            fill="x", padx=16, pady=(4, 2)
        )
        ...
        self.location_entry.pack(fill="x", padx=16, pady=(0, 20))
